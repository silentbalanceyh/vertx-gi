...
export enum EventAop {
    ...
    /** 激活 anchor 之后的限制，重新设置哪些节点可连入 **/
    onAfterEachAnchorActive = "aftereachanchoractive",
}